...
const SchedulingCalendarEdit = ({ handleClose, show, children }) => {
            ...
            <div className={showHideClassName}>
                <section className="modal-main">
                    ...
                    <div className="modal-body txt-16 txt-medium col-darkBlue">
                        ...
                        <div className="flex-grid3 modal-grid3-gaps cancel-create-p">
                            <div className="btn-common mouse-cursor delete justify-center">Delete</div>
...
export default SchedulingCalendarEdit;